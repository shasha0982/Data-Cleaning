...
# 3). BigBasket Entire Product List (~28K datapoints)
...
# 13). Restaurant Business Rankings 2020
...
# 16). eCommerce behavior data from multi category store
...
# 19). Consumer Behavior and Shopping Habits Dataset:
...
# 20). Dunnhumby - The Complete Journey
...
# 21). Bank marketing campaigns dataset | Opening Deposit
...
# 22). Social Media Influencers in 2022
